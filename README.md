...
| `VITE_SITE_URL`          | Used for canonical + Open Graph URLs        |
...
| Area   | Routes                                                                                     |
| ------ | ------------------------------------------------------------------------------------------ |
| Public | `/`, `/services`, `/services/:slug`, `/about`, `/gallery`                                   |
...
7. Update the origin in `robots.txt` and `sitemap.xml`.
...
| **Address, phone, email**   | Not present anywhere.                                                   |
| **Staff, reviews, statistics** | Not present anywhere.                                                |
